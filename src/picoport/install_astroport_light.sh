...
ln -sf "$HOME/.zen/Astroport.ONE/admin/system/astrosystemctl.sh" "$HOME/.local/bin/astrosystemctl"
ln -sf "$HOME/.zen/Astroport.ONE/cpcode"                    "$HOME/.local/bin/cpcode"   2>/dev/null || true
ln -sf "$HOME/.zen/Astroport.ONE/cpscript"                  "$HOME/.local/bin/cpscript" 2>/dev/null || true
...
"$HOME/.zen/Astroport.ONE/admin/system/cron_VRFY.sh" RECALIBRATE
